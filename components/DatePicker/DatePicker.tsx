...
const datePickerReducer: Reducer<
    ...
    switch (action.type) {
        case "SET_INIT_STATE": {
            ...
            const spanishWeekday =
                utilities.spanishDays[dayOfWeek].spanishCalendarWeekdayNumber
        ...
        case "ADD_MONTH": {
            ...
            const spanishFirstWeekdayNumber =
                utilities.spanishDays[newMonthFirstWeekdayNumber]
                    .spanishCalendarWeekdayNumber
...
const getSpanishDate = (date: Date): string => {
    ...
    const monthShortName = utilities.spanishMonths[date.getMonth()].shortName
    const day = ("0" + date.getDate()).slice(-2)
    const dayShortName = utilities.spanishDays[date.getDay()].shortName
...
const DatePicker = ({ label }: { label: string }) => {
    ...
    return (
        <div className='z-50 container mx-auto px-4 py-2 md:py-10'>
